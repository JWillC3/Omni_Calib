...
batch_7 <- trim_omni(omni_master, sheets_data, batch_number = 7)
...
#Define test end time for each batch!
...
#Batch 7
test_end <- as.POSIXct("2025-08-07 23:59", tz = "America/Denver")
#Call the function
p_batch_7 <- p_chamber_batch(batch_7, test_end, "Aug 7, 2025")
#Display plot
p_batch_7
